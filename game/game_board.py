...
#     # Draw walls
#     for wall in horizontal_walls:
#         pygame.draw.rect(screen, GREY, (wall[1] * CELL_SIZE, wall[0] * CELL_SIZE + CELL_SIZE - 5, CELL_SIZE * 2, 10))
    
#     for wall in vertical_walls:
#         pygame.draw.rect(screen, GREY, (wall[1] * CELL_SIZE + CELL_SIZE - 5, wall[0] * CELL_SIZE, 10, CELL_SIZE * 2))
...
#     if current_player:  # Player 1's turn
#         # Moving forward or backward (UP or DOWN)
#         if keys[pygame.K_w] and is_valid_move(player1_pos, 'UP'):  # Move forward (UP)
#             move_player(player1_pos, 'UP')
#             current_player = False
#         elif keys[pygame.K_s] and is_valid_move(player1_pos, 'DOWN'):  # Move backward (DOWN)
#             move_player(player1_pos, 'DOWN')
#             current_player = False
...
#     else:  # Player 2's turn
#         # Moving forward or backward (UP or DOWN)
#         if keys[pygame.K_UP] and is_valid_move(player2_pos, 'UP'):  # Move forward (UP)
#             move_player(player2_pos, 'UP')
#             current_player = True
#         elif keys[pygame.K_DOWN] and is_valid_move(player2_pos, 'DOWN'):  # Move backward (DOWN)
#             move_player(player2_pos, 'DOWN')
#             current_player = True
#         # Moving left or right
#         elif keys[pygame.K_LEFT] and is_valid_move(player2_pos, 'LEFT'):
...
def handle_turn():
    ...
    if current_player:  # Player 1's turn
        ...
        # Moving left or right
            ...
            current_player = False
        # Moving backward
        elif keys[pygame.K_z] and is_valid_move(player1_pos, 'DOWN'):  # Move backward (DOWN)
            move_player(player1_pos, 'DOWN')
            current_player = False
        ...
        # Moving left or right
            ...
            current_player = True
        # Moving backward
        elif keys[pygame.K_m] and is_valid_move(player2_pos, 'UP'):  # Move backward (UP)
            move_player(player2_pos, 'UP')
            current_player = True
